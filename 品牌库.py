...
brand_lib = {
    ...
    "莱珀妮": ["LP", "LaPrairie", "La Prairie", "莱珀"],
    "希思黎": ["Sisley", "希思黎"],
    "法尔曼": ["Valmont", "法尔曼"],
    ...
    "雅诗兰黛": ["EsteeLauder", "Estée Lauder", "雅诗", "雅诗兰黛", "红石榴"],
    "大宝": ["Embryolisse", "大宝"],
    ...
    "衰败城市": ["UD", "UrbanDecay", "Urban Decay", "衰败", "衰败城市"],
    "罗拉": ["LauraMercier", "Laura Mercier", "罗拉"],

    # 韩系
    "后": ["WHOO", "TheHistoryOfWhoo", "The History Of Whoo", "后", "后天", "后拱", "后津", "拱辰"],
    ...
    "梅森马吉拉": ["MaisonMargiela", "Maison Margiela", "MM", "马丁", "梅森马吉拉"],
